...
public abstract class Investigador {
	...
	public Investigador(String nif, String nombre, String apellidos,
			LocalDate fechaContratacion, double retribucion) {
	...
	public String getDatos() {
		...
		this.retribucion + " eur. " + Double.valueOf(df.format(this.getSubidaSalarial())) + " " +
		(this.getClass().getSimpleName().equals("InvestigadorTitular")
				? "Titular" : "Formacion");
	}

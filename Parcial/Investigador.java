...
public abstract class Investigador {
	...
	public String getDatos() {
		...
		return this.nif + " " + this.apellidos + ", " + this.nombre +
				"\t" + this.getAntigüedad() + " años \t" + this.retribucion + " eur. " +
				Double.valueOf(df.format(this.getSubidaSalarial())) + " " +
				(this.getClass().getSimpleName().equals("InvestigadorTitular")? "Titular" : "Formacion");
	}
}

...
public class InvestigadorFormacion extends Investigador {
	...
	public InvestigadorFormacion(String nif, String nombre, String apellidos, LocalDate fechaContratacion,
			double retribucion, boolean extraordinario) {
	...
	public double getSubidaSalarial() {
		...
		double factor = 0.025 + ((this.extraordinario) ? 0.01 : 0.0) +
				((super.getAntigüedad() >= 3) ? 0.01 : 0.0);
